<template>
	...
	<view v-if="loading" style="padding:0 32rpx;">
		...
		<view class="box1 box">
			...
			<view class="box1_item">
				...
				<view class="box1_item_left">
					<image class="goods_img" :src="dataObj.pics[0]" mode="aspectFill"></image>
				</view>
		...
		<view class="box2 box">
			...
			<view class="box2_item">
				<view class="box2_item_left">
					...
					<text class="text2" v-if="dataObj.limitCount > 0">
						此商品限购{{ dataObj.limitCount }}件
					</text>
				</view>
