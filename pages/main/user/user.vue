<template>
	...
	<z-paging ref="paging" use-page-scroll @query="storeGetinfo" :loading-full-fixed="true" hide-empty-view
		:loading-more-enabled="false" created-reload min-delay="1000">
		<!-- z-ping头部固定 -->
		<template #top>
			<!-- #ifndef H5 -->
			<!-- 标题栏 -->
