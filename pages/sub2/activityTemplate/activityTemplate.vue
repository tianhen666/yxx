<template>
	...
	<view
		...
		@tap="navigateTo('/pages/sub2/addActivityTemplate/addActivityTemplate')"
	>
		<text>添加</text>
		<text>模板</text>
	</view>
...
import { _enrollFormTemplateGetTemplateTypeList } from '@/aTemp/apis/activity.js'
...
// 获取分类列表
const getlist = () => {
	_enrollFormTemplateGetTemplateTypeList().then(res => {
