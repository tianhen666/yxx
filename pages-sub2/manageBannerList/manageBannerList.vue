			...
			<view class="right">
				...
				<view class="btn">
					<view
						...
						@tap="navigateTo(`/pages-sub2/manageBannerInput/manageBannerInput?id=${item.id}&prevCurrentIndex=${currentIndex}`)"
					>
						编辑
					</view>
...
import { _bannerList, _bannerDisable, _bannerDelete, _bannerEnable } from '@/api/yxxApi'
