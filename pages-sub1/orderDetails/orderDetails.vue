<template>
	...
	<view class="box1">
		...
		<!-- 图文信息 -->
		<m-left-right-layout rightWidth="430rpx">
			<template #left>
			...
			<template #right>
				<!-- 左右布局 -->
				<m-left-right-layout rightWidth="100rpx" alignItems="flex-start">
					<template #left>
						<!-- 标题 -->
						<view class="title">金属托槽矫正金属托槽矫正金属托槽矫金属托槽矫正金属托槽矫正金属托槽矫</view>
						<!-- 提示 -->
						<view class="tips">
